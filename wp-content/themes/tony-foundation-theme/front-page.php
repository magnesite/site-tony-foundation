		...
		<main id="main" class="front-page-main">
			...
			<div class="site-features-wrapper">
				<div class="site-feature">
					<a href="<?php echo site_url(); ?>/about#tonys-story"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="114px" height="125px">
						<g>
							...
							<text x="20" y="120" fill="#262626" font-size="20px" font-family="'Roboto Condensed', sans-serif">Tony's Story</text>
				</g>
					</svg>
				</a>
			</div><!--site-feature-->
			...
			<g>
		    <path d="M147.984,102.028l-147.984,-101.928l73.175,-0.1l74.85,51.014l-0.041,51.014Z" style="fill:#18706E;"/>
		    <g transform="matrix(0.829143,0.559037,-0.559037,0.829143,-1936.45,300.252)">
		      <text x="1482.26px" y="-1342.86px" style="font-family:'RobotoCondensed-Regular', 'Roboto Condensed';font-size:20px;fill:#fff;">Coming soon!</text>
		    </g>
		  </g>
		</svg>
	</a>
			...
			<div class="site-feature">
				<a href="<?php echo site_url(); ?>/tfcustompage/get-involved">
